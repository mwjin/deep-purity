...
def main():
    ...
    hist_width = 1000
    hist_height = 100
    mode = 0  # 0: images of variants (from 03_mto_summary.py), 1: images of variant samples (from 04_make_sample.py)
        ...
        for depth in depths:
            ...
            if mode == 0:  # make images of variants
                ...
                for norm_contam in norm_contams:
                    ...
                    out_image_dir = f'{PROJECT_DIR}/results/variant-sample-images/{cell_line}/{depth}/{purity_tag}'
                    os.makedirs(out_image_dir, exist_ok=True)
